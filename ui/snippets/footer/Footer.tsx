    ...
    (gridArea?: GridProps["gridArea"]) => {
      return (
        <Box gridArea={gridArea}>
          <Link fontSize="xs" href="https://ztcscan.com">
            ztcscan.com
          </Link>
          <Text mt={3} fontSize="xs">
            Zitcoin utilizes Bitcoin's native addresses, UTXO client
            verification, and integrates with Bitcoin's Layer 2 network through
            Taproot Consensus.
          </Text>
